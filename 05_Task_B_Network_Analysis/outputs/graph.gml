graph [
  ...
  node [
    id 4
    label "Civil Aviation Authority of Sri Lanka (CAASL)"
  ]
  node [
    id 5
  ...
  node [
    id 6
    label "Fuel Supply Companies"
  ]
  node [
    id 7
    label "Ground Handling Unit"
  ]
  node [
    id 8
  ...
  node [
    id 10
    label "Mattala Rajapaksa International Airport (MRIA)"
  ]
  node [
    id 11
    label "Mihin Lanka"
